#ifndef SOBELOUTLINES_INCLUED
#define SOBELOUTLINES_INCLUED
...
void GetDepthAndNormal(float uv, out float depth, out float3 normal)
{
    float coded = SAMPLE_TEXTURE2D(_DepthNormalsTexture, sampler_DepthNormalsTexture, uv);
